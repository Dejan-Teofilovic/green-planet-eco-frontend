...
export default function AccordionItem({ data, openedAccordions, handleAccordionOpening }: IProps) {
  ...
  return (
    ...
    >
      <AccordionHeader
        ...
        className="px-6 font-bold border-none text-left text-base md:text-xl"
      >
        {data.question}
      </AccordionHeader>
      <AccordionBody className="px-6 leading-8 text-gray-800">
        {data.answer}
      </AccordionBody>
    </Accordion>
  )
