...
const WHITEPAPER: Array<IWhitepaper> = [
  {
    id: 1,
    // title: 'Abstract:',
    description: 'The Green Planet Eco Blockchain is an innovative and advanced blockchain technology that has been implemented on the Ethereum network. Its primary purpose is to address urgent environmental concerns that the planet is currently facing. The architecture of this blockchain is decentralized, which ensures a reliable, transparent, and efficient system that promotes sustainable practices and facilitates the growth of the green economy.'
  },
  {
    id: 2,
    // title: 'Introduction:',
