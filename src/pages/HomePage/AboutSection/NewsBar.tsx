    ...
    <div>
      <Marquee direction="right">
        <div className="flex items-center gap-16 md:gap-48">
          ...
          <a href="https://icoholder.com/en/interview/make-the-earth-better-with-green-planet-eco" target="_blank" className="pr-16 md:pr-48">
            <img src="/assets/images/news_logo_icoholder.png" alt="coinpedia" className="w-48" />
          </a>
        </div>
      </Marquee>
    </div>
